 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Sara Harvey");
		  toPrint += p1.toString("sharvey7");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Annette Almonte");
		  toPrint += p2.toString("ajam3");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Keanna");
		  toPrint += p3.toString("ksion3");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Hayden");
          toPrint += p4.toString("902800242");
